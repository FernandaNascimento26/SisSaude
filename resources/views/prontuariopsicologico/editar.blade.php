...
<div class="container">
    ...
    <h1 style="font-size: 20px; font-family: Arial;">Editar Prontuario</h1>
    <br>


    <div id="formulario">
        <form method="POST" action="{{route('prontuariopsicologico.update',$pp->id)}}" id="form">
            @csrf
            ...
            <div class="row">
               <div class="form-group col-md-4">
                 ...
                 <input type="text" class="form-control" id="encaminhamento" name="encaminhamento" value="{{$pp->encaminhamento}}" placeholder="">
             </div>

             <div class="form-group col-md-4">
                 <label for="campo2">Situacao Escolar</label>
                 <input type="text" class="form-control" id="situacao_escolar" name="situacao_escolar" value="{{$pp->situacao_escolar}}" placeholder="">
             </div>

             <div class="form-group col-md-4">
                 <label for="campo3">Atividade Profissional</label>
                 <input type="text" class="form-control" id="atividade_profissional" name="atividade_profissional" value="{{$pp->atividade_profissional}}" placeholder="">
             </div>
         </div>
         ...
         <div class="row">
           <div class="form-group col-md-4">
             ...
             <input type="text" class="form-control" id="motivo_consulta" name="motivo_consulta" value="{{$pp->motivo_consulta}}"placeholder="">
         </div>
